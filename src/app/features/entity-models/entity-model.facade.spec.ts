    ...
    it('should extract indicator count from additional_info section', () => {
      const modelsWithSection: EntityModel[] = [{
        ...
        sections: [{
          ...
          last_updated_at: '2026-01-01T00:00:00Z',
          indicators: [
            { id: 'ind-1', name: 'Ind 1', technical_label: 'ind1', type: 'text', hidden_rule: 'false', required_rule: 'false', disabled_rule: 'false', default_value_rule: 'false', occurrence_min_rule: 'false', occurrence_max_rule: 'false', constrained_rule: 'false', position: 0, created_at: '2026-01-01T00:00:00Z', last_updated_at: '2026-01-01T00:00:00Z' },
            { id: 'ind-2', name: 'Ind 2', technical_label: 'ind2', type: 'number', hidden_rule: 'false', required_rule: 'false', disabled_rule: 'false', default_value_rule: 'false', occurrence_min_rule: 'false', occurrence_max_rule: 'false', constrained_rule: 'false', position: 1, created_at: '2026-01-01T00:00:00Z', last_updated_at: '2026-01-01T00:00:00Z' },
          ],
        }],
      }];
